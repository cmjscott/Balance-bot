...
void SSC32::Servo::set_degrees(float degrees)
{
	int ms = (degrees - m_deg_min) * (m_max - m_min) / (m_deg_max - m_deg_min) + m_min;
	set_position(ms);
}
...
void SSC32::Servo::config(int min, int max, float deg_min, float deg_max)
{
	m_min = min;
	m_max = max;
	m_deg_min = deg_min;
